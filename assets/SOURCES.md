...
| Local asset | Source |
| --- | --- |
| `n1-patient-consultation.webp` | Patient consultation photograph / Pexels |
...
source before this goes public.** It is used decoratively (`alt=""`) and is not
presented as a photograph of an n1 patient.

The `patient-story-*.jpg` images do not depict n1 patients. Recorded Pexels source
pages and creators are listed above.
